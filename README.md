...
# pySQL Zoo
A way to showcase my solutions to going the [SQL Zoo](https://sqlzoo.net/wiki/SQL_Tutorial) using the sqlite3 package in Python.
...
All of these solutions are my own personal work.